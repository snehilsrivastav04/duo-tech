  ...
  return (
    <section className="relative py-32 bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="relative bg-slate-900 dark:bg-[#071a14] rounded-[3rem] overflow-hidden border border-slate-800/50 shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 p-8 md:p-20 border-b lg:border-b-0 lg:border-r border-slate-800/50">
              ...
              >
                ...
                <h2 className="text-5xl md:text-7xl font-light tracking-tighter text-white leading-[0.95] mb-8">
                  Engineer your <br />
                  <span className="italic font-normal text-slate-500 text-4xl md:text-6xl">customer dialogue.</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    href="/contact"
                    className="group px-10 py-5 bg-[#25D366] hover:bg-[#20bd5a] text-slate-950 rounded-full text-sm font-bold uppercase tracking-widest flex items-center justify-center gap-3 transition-all duration-300 shadow-lg shadow-green-900/20"
                  >
                    Get Started Free
            ...
            <div className="lg:col-span-5 p-12 md:p-20 bg-slate-950/40 flex flex-col justify-center">
              <div className="space-y-12">
                ...
                <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm">
                  <div className="flex gap-4 mb-4">
                    <div className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center text-slate-950">
        ...
        <div className="mt-12 text-center opacity-40">
           <span className="text-[9px] font-bold tracking-[0.4em] uppercase">Built for Scale • UTC +5:30 Deployment • Global Reach</span>
        </div>
