...
interface DesignServices {
  branding: DesignService[];
  digital: DesignService[];
  print: DesignService[];
  motion: DesignService[];
}
...
const GraphicsDesignPage = () => {
  ...
  const designServices: DesignServices = {
    branding: [
      {
        id: 1,
        title: "Logo Design",
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                >
                  <button 
                    onClick={goToContact}
                    className="group px-8 py-4 bg-blue-900 text-white rounded-full hover:bg-blue-800 transition-all duration-300 flex items-center space-x-2"
                  >
                  ...
                  <button 
                    onClick={goToContact}
                    className="px-8 py-4 border border-gray-300 text-gray-700 rounded-full hover:border-blue-900 hover:text-blue-900 transition-all duration-300"
                  >
                    View Portfolio
                  </button>
                </motion.div>
            ...
            >
              ...
              <div className="flex justify-start mb-16 border-b border-gray-200">
                {[
                  ...
                  <motion.button
                    key={tab.id}
                    onClick={() => setActiveTab(tab.id as 'branding' | 'digital' | 'print' | 'motion')}
                    whileHover={{ y: -2 }}
              ...
              <div className="space-y-2">
                {designServices[activeTab].map((service: DesignService, index: number) => (
                  <motion.div
                    key={service.id}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              >
                <button 
                  onClick={goToContact}
                  className="px-8 py-4 border border-blue-900 text-blue-900 rounded-full hover:bg-blue-900 hover:text-white transition-all duration-300 inline-flex items-center space-x-2"
                >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <button 
                  onClick={goToContact}
                  className="px-8 py-4 bg-white text-blue-900 rounded-full hover:bg-gray-100 transition-all duration-300 inline-flex items-center space-x-2"
                >
