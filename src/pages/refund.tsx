                  ...
                  <div>
                    ...
                    <ol className="space-y-3 ml-6">
                      <li className="flex items-start">
                        ...
                        <span>Submit written refund request to billing@duotech.com</span>
                      </li>
                      <li className="flex items-start">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-neutral-600 mt-1">
                            Email cancellation request to billing@duotech.com from registered email
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
              ...
              <div className="bg-white p-8 border border-neutral-200">
                ...
                <div className="space-y-4 text-sm text-neutral-700">
                  <div>
                    ...
                    <br />
                    <a href="mailto:billing@duotech.com" className="underline">
                      billing@duotech.com
                    </a>
                  </div>
                  <div>
